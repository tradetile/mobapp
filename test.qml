...
Window {
    ...
    Rectangle {
        ...
        Grid {
            ...
            //! listModel - to contain all the data.
            ListModel{
                id: listModel
                ListElement { _color: "red" }
                ListElement { _color: "green" }
            }
            //! Repeater - repeate from list-model
            Repeater{
                model: listModel
                //! delegate to renderer.
                delegate: Cell2{cellColor: _color; onClicked: function(c){return grid.clicked(c)} ; width: grid.width/3; height: grid.height/2}
            }
        }
    }
}
